...
export function Footer(){
    return(
        ...
        <div className="text-white bg-[#111]  flex flex-col items-center justify-between space-y-8  font-serif">
          ...
          <a href="https://www.linkedin.com/in/aman-gupta-b2b40414b/" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://github.com/amangt23" target="_blank" rel="noopener noreferrer">
          ...
          <a href="mailto:amangt23@gmail.com" target="_blank" rel="noopener noreferrer">
