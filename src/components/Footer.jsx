            ...
            <div className="absolute top-0 left-0 w-[100%] overflow-hidden bg-[#111]">
                ...
                <div className="text-white bg-[#111]  flex flex-col items-center justify-between space-y-8  font-serif">
                    ...
                    <div className="flex flex-row justify-between items-center space-x-10 sm:space-x-16">
                        {/* LinkedIn Icon */}
                        <a href="https://www.linkedin.com/in/aniket-gupta-b56717158/" target="_blank" rel="noopener noreferrer">
                        ...
                        {/* GitHub Icon */}
                        <a href="https://github.com/aniketgupta23" target="_blank" rel="noopener noreferrer">
                        ...
                        {/* Gmail Icon */}
                        <a href="mailto:amangt23@gmail.com">
                            <svg className="sm:w-9 w-6 hover:text-white hover:scale-110 ease-in-out duration-200" fill="currentColor" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
